...
def parser() -> argparse.ArgumentParser:
    ...
    create.add_argument("--parameter", action="append", default=[], help="Calibration parameter name; when provided, calibrate this full list exactly as given")
    create.add_argument("--prior-file", default=None, help="JSON file with explicit prior specs; bounds must still be explicit")
    create.add_argument("--prior", action="append", default=[], help="Prior override like theta=uniform(0,1)")
    create.add_argument("--parameter-bound", action="append", default=[], help="Required exact parameter bound like theta=0:1")
    ...
    inspect_model.add_argument("--parameter", action="append", default=[], help="Calibration parameter name; when provided, inspect and calibrate this full list exactly as given")
    inspect_model.add_argument("--prior-file", default=None)
    inspect_model.add_argument("--prior", action="append", default=[])
    inspect_model.add_argument("--parameter-bound", action="append", default=[], help="Exact parameter bound like theta=0:1")
